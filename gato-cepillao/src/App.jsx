  ...
  return (
    ...
    >
      ...
      {pantalla === "Login" && (
        <Login
          onLogin={handleLogin}
          onRegister={() => setPantala("Register")}
        />
      )}
      {pantalla === "Register" && (
        <Register onVolver={() => setPantala("Login")} />
      )}
        ...
        >
          ...
          >
            <span style={{ fontSize: "11px" }}>
              NOTEPAD.EXE - peina_al_gatete.tunna
            </span>
          ...
          >
            {["FILE", "OPTIONS", "WINDOW", "HELP"].map((m) => (
              <span
                key={m}
                style={{ fontSize: "11px", cursor: "pointer", color: "#000" }}
              >
                {m}
              </span>
            ))}
            ...
            >
              ...
              >
                <p style={{ fontSize: "12px" }}>
                  NOMBRE: <span style={{ color: "#555" }}>{namePlayer}</span>
                </p>
                <p style={{ fontSize: "12px" }}>
                  OBJETIVO:{" "}
                  <span style={{ color: "#555" }}>No te dejes atrapar</span>
                </p>
                <p style={{ fontSize: "12px" }}>
                  DIFICULTAD: <span style={{ color: "#555" }}>tu decides</span>
                </p>
              </div>
              <hr style={{ border: "none", borderTop: "1px solid #ddd" }} />
            ...
            >
              ...
              <div
                style={{
                  flex: 1,
                  background:
                    "repeating-linear-gradient(45deg,#f0f0f0,#f0f0f0 1px,#e0e0e0 1px,#e0e0e0 2px)",
                }}
              ></div>
              <div
                style={{
          ...
          >
            ...
            >
              C:\juegos\peina_al_gatete.tunna
            </span>
            <span
              style={{
                fontSize: "10px",
